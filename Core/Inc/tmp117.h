...
#define     TMP117_DeviceID1 0x48<<1
#define     TMP117_DeviceID2 0x49<<1
#define     TMP117_DeviceID3 0x4A<<1
#define     TMP117_DeviceID4 0x4B<<1

#define			TMP117_Device_ID 0x117 /* Device ID */
